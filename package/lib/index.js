...
exports.NativeMotion = exports.AnimatedExit = void 0;
...
function createMotionComponent(Component) {
    return react_1.default.forwardRef((props, ref) => {
        const { initial = {}, animate = {}, exit = {}, presenceAnimation = {}, transition = DEFAULT_TRANSITION, whileHover, // Future Implementation
        whileTap, // Future Implementation
        whileFocus, // Future Implementation
        layout, // Future Implementation
        layoutId, // Future Implementation
        styles = {}, children, animationId = null, isPresent, onExitComplete, exitComplete, markPresent } = props, rest = __rest(props, ["initial", "animate", "exit", "presenceAnimation", "transition", "whileHover", "whileTap", "whileFocus", "layout", "layoutId", "styles", "children", "animationId", "isPresent", "onExitComplete", "exitComplete", "markPresent"]);
        ...
        const trackAniamtion = (finished) => {
            if (finished && onExitComplete) {
                (0, react_native_reanimated_1.runOnJS)(onExitComplete)();
            }
        };
        // Animation helper
        const animateToValues = (0, react_1.useCallback)((targetValues, transitionConfig = transition, isChildPresent) => {
            Object.entries(targetValues).forEach(([key, value]) => {
                ...
                if (value !== undefined) {
                    ...
                    if (['backgroundColor', 'color', 'borderColor', 'shadowColor'].includes(key)) {
                        ...
                        progress.value = 0;
                        progress.value = (0, react_native_reanimated_1.withDelay)((_a = transitionConfig.delay) !== null && _a !== void 0 ? _a : DEFAULT_TRANSITION.delay, (0, react_native_reanimated_1.withTiming)(1, {
                            duration: (_b = transitionConfig.duration) !== null && _b !== void 0 ? _b : DEFAULT_TRANSITION.duration,
                        }, trackAniamtion));
                        return;
                    }
                    ...
                    if (sharedValue) {
                        ...
                        if (transitionConfig.repeat &&
                            ...
                            const baseAnimation = transitionConfig.type === 'spring'
                                ? (0, react_native_reanimated_1.withDelay)((_c = transitionConfig.delay) !== null && _c !== void 0 ? _c : DEFAULT_TRANSITION.delay, (0, react_native_reanimated_1.withSpring)(value, {
                                    ...
                                    mass: (_f = transitionConfig.mass) !== null && _f !== void 0 ? _f : 1,
                                }, trackAniamtion))
                                : (0, react_native_reanimated_1.withDelay)((_g = transitionConfig.delay) !== null && _g !== void 0 ? _g : DEFAULT_TRANSITION.delay, (0, react_native_reanimated_1.withTiming)(value, {
                            ...
                            config =
                                transitionConfig.type === 'spring'
                                    ? (0, react_native_reanimated_1.withSpring)(value, {
                                        damping: (_j = transitionConfig.damping) !== null && _j !== void 0 ? _j : DEFAULT_TRANSITION.damping,
                                        stiffness: (_k = transitionConfig.stiffness) !== null && _k !== void 0 ? _k : DEFAULT_TRANSITION.stiffness,
                                        mass: (_l = transitionConfig.mass) !== null && _l !== void 0 ? _l : 1,
                                    }, trackAniamtion)
                                    : (0, react_native_reanimated_1.withTiming)(value, {
                                        duration: (_m = transitionConfig.duration) !== null && _m !== void 0 ? _m : DEFAULT_TRANSITION.duration,
                                    }, trackAniamtion);
                        }
                        if (transitionConfig.delay) {
                            sharedValue.value = (0, react_native_reanimated_1.withDelay)(transitionConfig.delay, config);
                        }
                        else {
        ...
        const getSharedValue = (0, react_1.useCallback)((key) => {
        ...
        (0, react_1.useEffect)(() => {
            ...
            (0, react_native_reanimated_1.runOnJS)(markPresent)();
        }, []);
        ...
        return react_1.default.createElement(AnimatedComponent, Object.assign(Object.assign({ ref, style: [styles, animatedStyle] }, presenceAnimation), rest), children);
    });
}
...
var AnimatedExit_1 = require("./AnimatedExit");
Object.defineProperty(exports, "AnimatedExit", { enumerable: true, get: function () { return AnimatedExit_1.AnimatedExit; } });
